...
<div className="flex flex-col items-center justify-center text-gray-600 w-full col-span-3 mt-20">
<svg
  ...
  className="lucide lucide-house mb-4"
>
  <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8" />
  <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
</svg>
<p className="text-lg font-semibold text-center">Nenhum imóvel encontrado</p>
<p className="text-sm text-gray-500 text-center">Tente ajustar os filtros para encontrar mais opções.</p>
</div>
